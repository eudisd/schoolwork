...
create_clock -period 100.000 -waveform {0.000 50.000} [get_ports { w_addr[2] } ] -name w_addr[2]  
# WARNING:  The required clock period is not set. The default value (100 ns) is used. 
create_clock -period 100.000 -waveform {0.000 50.000} [get_ports { w_addr[1] } ] -name w_addr[1]  
# WARNING:  The required clock period is not set. The default value (100 ns) is used. 
create_clock -period 100.000 -waveform {0.000 50.000} [get_ports { clock4 } ] -name clock4  
# WARNING:  The required clock period is not set. The default value (100 ns) is used. 
create_clock -period 100.000 -waveform {0.000 50.000} [get_ports { w_addr[0] } ] -name w_addr[0]  
...
set_load -pin_load 0 [get_ports { dataout[0] } ]
set_load -pin_load 0 [get_ports { dataout[1] } ]
set_load -pin_load 0 [get_ports { dataout[2] } ]
set_load -pin_load 0 [get_ports { dataout[3] } ]
set_load -pin_load 0 [get_ports { dataout[4] } ]
set_load -pin_load 0 [get_ports { dataout[5] } ]
set_load -pin_load 0 [get_ports { dataout[6] } ]
set_load -pin_load 0 [get_ports { dataout[7] } ]
